...
const unsigned long RUN_INTERVAL_MILLIS = 6000; // how often to run the Choreo (in milliseconds)
...
void loop()
{
  ...
  if (now - lastRun >= RUN_INTERVAL_MILLIS) {
    ...
    unsigned long sensorValue = random(40);
    ...
    AppendRowChoreo.setAppKey("4aXHBeqmIWX08DnrVttCFpJ07JL5YTuN");
